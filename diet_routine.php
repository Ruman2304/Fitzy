                    ...
                    <center>
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <a href="javascript:del_item('<?php echo "./diet_routine.php?diet_id=".$Dietfood_Id;?>');" class="btn btn-primary">Remove from routine</a>
                            </div>
                        </div>
                    </center>
                </div>
